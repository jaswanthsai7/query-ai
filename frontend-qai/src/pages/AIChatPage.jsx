...
const AIChatPage = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row h-[calc(100vh-128px)] bg-gradient-to-br text-white p-4 gap-4">
      {/* Left Chat Section */}
      <div className="w-full md:w-1/2 bg-white/10 backdrop-blur-md rounded-2xl shadow-lg border border-white/20 overflow-hidden flex flex-col">
        {loading ? (
      ...
      <div className="w-full md:w-1/2 bg-white/10 backdrop-blur-md rounded-2xl shadow-lg border border-white/20 p-4 flex flex-col overflow-hidden">
        {loading ? (
